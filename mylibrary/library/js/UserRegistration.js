               var form_submitted = "0";
                ...
                $('#UserRegistration_1514917765').validate({ ignore: "",
                    ...
                    highlight: function(element) {
                        $(element).closest(".form-group").addClass("has-error_UserRegistration_1514917765");
                    },
                    unhighlight: function(element) {
                        $(element).closest(".form-group").removeClass("has-error_UserRegistration_1514917765");
                    },
                    errorClass: "error-class_UserRegistration_1514917765",
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            type: $('#UserRegistration_1514917765').attr('method'),
                            url: $('#UserRegistration_1514917765').attr('action'),
                            data: form_data,
                            dataType: "json",

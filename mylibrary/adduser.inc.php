			...
			if($baduser != 1)
{
	...
	$query  = "INSERT INTO users(userid, firstname, lastname, phone, ext, catalogid, email, password) VALUES ('$userid', '$firstname', '$lastname', '$phone', '$ext',  '$email',PASSWORD('$password1'))";

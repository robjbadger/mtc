...
font-size: 32px;
    ...
    if(!isset($_SESSION['mesa_user']))
    {
    	include "../mylibrary/loginalerts.php";
     	...
     	echo "<h6 class='hide-on-print'>To print or save a copy of this catalog, click the print button. <div class='button-group'><button class='btn btn-primary' onclick='window.print();return false;' title='Print Catalog' ><i class='fa fa-print' aria-hidden='true'></i></button></div></h6>";
    ...
    $assoc3 = $row[ 'assocprod3' ];
    	...
    	echo "<tr><td align='center'><img src='../mylibrary/showimage.php?id=$prodid' width='80' height='auto' class='img-responsive center-block'>";
